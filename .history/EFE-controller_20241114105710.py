...
# Configurazione dell'indirizzo e della porta di InfluxDB
url = "http://localhost:8086"  # Modifica se necessario
token = "il_tuo_token"          # Imposta il token se necessario
org = "la_tua_organizzazione"   # Specifica l'organizzazione, se applicabile
bucket = "il_tuo_bucket"        # Inserisci il nome del bucket
