...
def main():
    ...
    # Parser per "attach"
    attach_parser = subparsers.add_parser("attach", help="Altri comandi da implementare in futuro.")
    attach_parser.add_argument("interface", help="Nome dell'interfaccia.")
    attach_parser.add_argument("probe", help="Tipo di probe.")
    attach_parser.add_argument("probe_id", help="ID del probe.")
