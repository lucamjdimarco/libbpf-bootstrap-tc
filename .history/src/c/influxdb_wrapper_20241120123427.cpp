...
int InfluxDBWrapper::writeData(uint64_t ts, const std::string& str_identifier, uint64_t counter) {
	...
	point.addTag("flowid", flowid);
    point.addField("value", static_cast<double>(counter));
