...
int write_data_influxdb_batch(MHandler_t *h, uint64_t *ts, std::string str_identifier, uint64_t *counter, size_t count) {
    InfluxDBWrapper *obj;
    ...
    std::vector<std::string> str_vec(str_identifier, str_identifier + count);
