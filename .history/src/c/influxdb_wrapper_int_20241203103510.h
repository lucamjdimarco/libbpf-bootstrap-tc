...
extern "C" {
	...
	int write_data_influxdb_batch(MHandler_t *h, uint64_t *ts, const char *machine_ids[BATCH_SIZE], const char *interfaces[BATCH_SIZE], const char *fnames[BATCH_SIZE], uint64_t *flowid, uint64_t *counter, size_t count);
