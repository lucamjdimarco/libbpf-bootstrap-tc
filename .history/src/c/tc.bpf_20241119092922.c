					 ...
					 bool start_timer)
{
	...
	bpf_snprintf(initial_part, sizeof(initial_part), "%s:%s", machine_id, interface);
	bpf_snprintf(formatted_value, sizeof(formatted_value), "%s:%llu", initial_part, packet->flow_id);
